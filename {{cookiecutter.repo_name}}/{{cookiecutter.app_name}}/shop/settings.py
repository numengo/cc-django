...
STATICFILES_FINDERS = [
    '{{ cookiecutter.app_name }}.shop.finders.FileSystemFinder',  # or 'django.contrib.staticfiles.finders.FileSystemFinder',
    '{{ cookiecutter.app_name }}.shop.finders.AppDirectoriesFinder',  # or 'django.contrib.staticfiles.finders.AppDirectoriesFinder',
